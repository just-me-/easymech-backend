...
{
    public partial class Servicessimplified : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceId1 = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Arbeitsschritt", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Arbeitsschritt_ServiceDurchfuehrung_ServiceId",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Arbeitsschritt_GeplanterService_ServiceId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bezeichnung = table.Column<string>(maxLength: 256, nullable: true),
                    ServiceId = table.Column<long>(nullable: false),
                    ServiceDurchfuehrungId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Arbeitsschritt_ServiceId1",
                schema: "public",
                table: "Arbeitsschritt",
                column: "ServiceId1");
