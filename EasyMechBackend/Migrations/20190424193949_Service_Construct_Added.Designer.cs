...
namespace EasyMechBackend.Migrations
{
    ...
    [Migration("20190424193949_Service_Construct_Added")]
    partial class Service_Construct_Added
    {
            ...
            modelBuilder.Entity("EasyMechBackend.DataAccessLayer.FahrzeugRuecknahme", b =>
                {
                    ...
                    b.ToTable("FahrzeugRuecknahme","public");
                });
            ...
            modelBuilder.Entity("EasyMechBackend.DataAccessLayer.FahrzeugRuecknahme", b =>
                {
                    b.HasOne("EasyMechBackend.DataAccessLayer.FahrzeugUebergabe", "FahrzeugUebergabe")
                        .WithOne("Ruecknahme")
                        .HasForeignKey("EasyMechBackend.DataAccessLayer.FahrzeugRuecknahme", "UebergabeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
